...
def process():
    ...
    if PERCENTAGE_CHEAT > CHEAT_THRESH:
        GLOBAL_CHEAT = 1
        print("CHEATING") #print("Lavesh hero ahe")
    else:
        GLOBAL_CHEAT = 0
    print("Cheat percent: ", PERCENTAGE_CHEAT, GLOBAL_CHEAT) #print("Ankit Chutiye ahe")

def run_detection():
    # print(" detection chalu zale")
